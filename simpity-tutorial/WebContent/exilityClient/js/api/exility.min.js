...
var getMessageText=function(b){return b.getMessageText()},confirmReset=function(){message("server reset","","Ok",null,null,null)},HeaderMenu=function(){this.options="directories\x3dno, location\x3dno, resizable\x3dyes, menubar\x3dno, status\x3dno, titlebar\x3dno, scrollbars\x3dyes, toolbar\x3dno";this.resetServer=function(){var b=new ServiceEntry("ide.resetProject",new DataCollection,!0,confirmReset,null,null,!1,!0);exilityMainWindow.serverStub.callService(b)};this.startTrace=function(b){var c=htmlRootPath;
b||(c+="../exilityClient/htm/",b="exilityTraceWindow");c+="common/trace.htm";b=b||"exilityTraceWindow";if(!window.exilityTraceWindow||window.exilityTraceWindow.closed)window.exilityTraceWindow=window.open(c,b,this.options+", left\x3d0, top\x3d0, height\x3d500, width\x3d600",!0);window.exilityTraceWindow?window.exilityTraceWindow.focus():alert("Unable to open trace window because of pop-up blocker. You will not see trace information.")};this.traceClosed=function(){exilityTraceWindow=null};this.startTestHarness=
function(){window.testCaseToBeCaptured=!0};this.endTestHarness=function(){window.testCaseToBeCaptured=!1};this.showData=function(){if(window.dataStore){var b=window.open("","_blank"),c=b.document;c.write(dataStore.toHtml());c.close();b.focus()}else{var d=currentActiveWindow.P2;if(d){b=window.open("","_blank");c=b.document;c.write('\x3ch2\x3evalues\x3c/h2\x3e\x3ctable cellpadding\x3d"3" cellspacing\x3d"1" style\x3d"background-color:blue;"\x3e\x3ctr style\x3d"background-color:gray"\x3e\x3cth\x3eName\x3c/th\x3e\x3cth\x3eValue\x3c/th\x3e\x3c/tr\x3e');
...
exilCombo=document.getElementById("exilComboFrame");(exilComboWin=window.frames.exilComboFrame)&&exilParms.comboMaxRows&&(exilComboWin.comboMaxRows=exilParms.comboMaxRows)},getLocalResource=function(b,c){var d;b=topPath+b;try{if("undefined"!=typeof ActiveXObject){if(c){d=new ActiveXObject("Msxml2.XMLHTTP.6.0");d.open("GET",b,!1);d.send();var f=d.responseText;d=new ActiveXObject("Microsoft.XMLDOM");d.async=!1;d.loadXML(f);if(!d.documentElement){alert(b+" loaded into an empty document. Check for errors.\n"+
d.parseError);return}return d.documentElement}d=new ActiveXObject("Msxml2.XMLHTTP.6.0");d.open("GET",urlextT,!1);d.send();return d.responseText}d=new XMLHttpRequest;d.open("GET",b,!1);d.send(null);return d=c?d.responseXML.documentElement:d.responseText}catch(g){return alert("Error while accessing "+b+"\n"+g),null}},htmlClicked=function(){urlArea.style.display="";urlField.focus()},goClicked=function(){headerMenu.navigate(urlField.value);urlArea.style.display="none"},showWindow=function(b){if(b=document.getElementById(b.name+
"Div"))b.style.display=""},hideWindow=function(b){if(b=document.getElementById(b.name+"Div"))b.style.display="none"},closeWindow=function(b){if(b){removeInbox(b.name);var c=document.getElementById(b.name+"Div");b.location.href="about:blank";try{c.parentNode.removeChild(c)}catch(d){}}},createWindow=function(b,c){lastWindowNumberUsed++;var d="main"+lastWindowNumberUsed,f=document.createElement("DIV");f.id=d+"Div";var g='style\x3d"width: 1028px; height: 570px;"';c&&(f.style.display="none",g=' style\x3d"border:solid 0px #E8E8E8;position:absolute; z-index:2; background-color: #FFF;  -webkit-box-shadow: 0px 8px 32px rgba(0,0,0,0.5);-webkit-border-radius: 5px;-moz-box-shadow: 0px 8px 32px rgba(0,0,0,0.5);-moz-border-radius: 5px;" ',
...
c+d[h][f],c+="\x3c/td\x3e";c+="\x3c/tr\x3e"}c+="\x3c/table\x3e"}return c+="\x3c/table\x3e"},scrollIntoView=function(b){if(b&&b.parentNode){for(var c=b.parentNode;c&&"body"!=c.nodeName.toLowerCase();){if(c.scrollHeight!=c.clientHeight&&c.scrollHeight!=c.offsetHeight){b.offsetTop<c.scrollTop?c.scrollTop=b.offsetTop:b.offsetTop>c.scrollTop+c.clientHeight?c.scrollTop=b.offsetTop-c.clientHeight+b.clientHeight:debug(" No need to scroll ");return}c=c.parentNode}debug("No scrolled parent found for "+b.id)}else debug(b+
" is not a dom element. scrollIntoView() will not work")},findXY=function(b){var c=0,d=0;IdentifyBrowser.init();if("Explorer"==IdentifyBrowser.browser){if(b.offsetParent)for(;;){d+=b.offsetLeft;c+=b.offsetTop;if(!b.offsetParent)break;b=b.offsetParent}}else if("Firefox"==IdentifyBrowser.browser&&!0==exilParms.alignCalendar){if(b.offsetParent)for(;;){d+=b.offsetLeft;c+=b.offsetTop;if(!b.offsetParent)break;b=b.offsetParent}}else if("Firefox"==IdentifyBrowser.browser&&b.parentNode)for(;;){d+=parseInt(b.offsetLeft);
c+=parseInt(b.offsetTop);if(!b.parentNode||"DIV"==b.tagName&&"top"==b.id)break;b=b.parentNode}return{x:d,y:c}},messageBtnAction1=null,messageBtnAction2=null,messageBtnActionParam1=null,messageBtnActionParam2=null,messageEles=null,message=function(b,c,d,f,g,h,k,l,m){window.messageEles||cacheMessageElements();d||(d="OK");var n=messageEles.msgDiv;if(n){coverMainStyle.zIndex=6;coverPage(coverMainStyle,imgMainStyle);messageBtnAction2=messageBtnAction1=null;if(null!=messageEles.msgLabel)c&&(messageEles.msgLabel.innerHTML=
c),messageEles.msgText.innerHTML=b.replace(/&/g,"\x26amp;").replace(/</g,"\x26lt;");else{var r=b.indexOf("\n");0>r?(c=b,b=""):(c=b.substr(0,r),b=b.substr(r+1));messageEles.msgHeader.innerHTML=c;b=b.split("\n").join("\x3cbr /\x3e\x3cbr /\x3e");messageEles.msgDetail.innerHTML=b}messageEles.msgBtnText1.innerHTML=d&&0<d.length?"Ok"==d||"ok"==d?"OK":d:"OK";f&&(messageBtnAction1=f,k&&(messageBtnActionParam1=k));g?(messageEles.msgBtnText2.innerHTML=g,messageEles.btnDiv2.style.display="",h&&(messageBtnAction2=
h,l&&(messageBtnActionParam2=l))):messageEles.btnDiv2.style.display="none";n.style.display="block";d=n.style.height;d=d.replace(/[p,P][x,X]/g,"");f=n.style.width;f=f.replace(/[p,P][x,X]/g,"");""==d&&(d=n.offsetHeight);""==f&&(f=n.offsetWidth);g=document.body.scrollLeft;h=window.innerWidth;n.style.top=document.body.scrollTop+window.innerHeight/2-d/2-25+"px";n.style.left=g+h/2-f/2-225+"px";messageEles.morePanel&&(d=n="",m&&m.additionalMessageName?(n=dataTypeMessages[m.additionalMessageName]||"Sorry. We can not show additional help for this field, as we encountered an internal error while retrieving message for "+
m.additionalMessageName,n=n.replace(/&/g,"\x26amp;"),mag=n.replace(/</g,"\x26lt;")):d="none",messageEles.morePanel.innerHTML=n,messageEles.morePanel.style.display="none",messageEles.moreBtnDiv.style.display=d)}else if(g?window.confirm(b)?f&&executeFunction(f,k):executeFunction(h,l):(n=document.getElementById("warningMsg"))?(alignMsgBox(),showMessageInPanel(c,b,n)):(alert(b),f&&executeFunction(f,k)),k)try{showPanelForSure(k.parentNode),k.focus&&k.focus(),k.select&&k.select()}catch(q){}},executeFunction=
function(b,c){if("function"==typeof b)b(c);else{var d=currentActiveWindow[b];"function"==typeof d?d(c):currentActiveWindow.P2.act(null,null,b)}},showMessageInPanel=function(b,c,d){d.style.display="block";d.style.height.replace(/[p,P][x,X]/g,"");d.style.width.replace(/[p,P][x,X]/g,"");var f=c.substring(0,5);d.style.display="";d.className=b?"error":"error"==f?"error":"success";document.getElementById("warningMsg").innerHTML=c},cacheMessageElements=function(){window.messageEles={msgDiv:document.getElementById("messageBox"),
msgLabel:document.getElementById("messageLabel"),msgText:document.getElementById("messageText"),msgHeader:document.getElementById("messageHeader"),msgDetail:document.getElementById("messageDetail"),msgBtnText1:document.getElementById("messageButton1"),msgBtnText2:document.getElementById("messageButton2"),btnDiv2:document.getElementById("messageButtonDiv2"),morePanel:document.getElementById("messageAdditionalPanel"),moreBtnDiv:document.getElementById("messageButtonDiv3")}},showPanelForSure=function(b){var c=
b&&b.ownerDocument;if(c)for(;"BODY"!=b.tagName.toUpperCase();b=b.parentNode){var d=b.id,f=c.getElementById(d+"TabsDiv");if(f)"none"==f.style.display&&(b=f,f=c.getElementById(d+"Tab"),f.onclick(f,b.id));else if(b.style&&"none"==b.display)if(f=c.getElementById(d+"Twister"))f.onclick(f,d);else b.style.display=""}else debug("wrong object "+b+" sent to showPanelForSure")},messageButtonClicked=function(b){document.getElementById("messageBox").style.display="none";coverMainStyle.zIndex=2;currentActiveWindow.isAPopup||
uncoverPage(coverMainStyle,imgMainStyle);"messageButton1"==b&&null!=messageBtnAction1?executeFunction(messageBtnAction1,messageBtnActionParam1):"messageButton2"==b&&null!=messageBtnAction2&&executeFunction(messageBtnAction2,messageBtnActionParam2)},dragObj={zIndex:0},isIE=window.document.all,dragStart=function(b,c){var d,f;c?dragObj.elNode=document.getElementById(c):(dragObj.elNode=window.event.srcElement,dragObj.elNode||(dragObj.elNode=b.target));isIE?(d=window.event.clientX+document.documentElement.scrollLeft+
document.body.scrollLeft,f=window.event.clientY+document.documentElement.scrollTop+document.body.scrollTop):(d=b.clientX+window.scrollX,f=b.clientY+window.scrollY);dragObj.cursorStartX=d;dragObj.cursorStartY=f;dragObj.elStartLeft=parseInt(dragObj.elNode.style.left,10);dragObj.elStartTop=parseInt(dragObj.elNode.style.top,10);isNaN(dragObj.elStartLeft)&&(dragObj.elStartLeft=0);isNaN(dragObj.elStartTop)&&(dragObj.elStartTop=0);dragObj.elNode.style.zIndex=++dragObj.zIndex;isIE?(document.attachEvent("onmousemove",
dragGo),document.attachEvent("onmouseup",dragStop),window.event.cancelBubble=!0,window.event.returnValue=!1):(document.addEventListener("mousemove",dragGo,!0),document.addEventListener("mouseup",dragStop,!0),b.preventDefault())},dragGo=function(b){var c,d;isIE?(c=window.event.clientX+document.documentElement.scrollLeft+document.body.scrollLeft,d=window.event.clientY+document.documentElement.scrollTop+document.body.scrollTop):(c=b.clientX+window.scrollX,d=b.clientY+window.scrollY);dragObj.elNode.style.left=
dragObj.elStartLeft+c-dragObj.cursorStartX+"px";dragObj.elNode.style.top=dragObj.elStartTop+d-dragObj.cursorStartY+"px";isIE?(window.event.cancelBubble=!0,window.event.returnValue=!1):b.preventDefault()},dragStop=function(b){isIE?(document.detachEvent("onmousemove",dragGo),document.detachEvent("onmouseup",dragStop)):(document.removeEventListener("mousemove",dragGo,!0),document.removeEventListener("mouseup",dragStop,!0))},showToolTip=function(b){b=b.id.replace("docNodeName","docXpath");PM.toolTipEle.innerHTML=
'\x3cspan class\x3d"field" style:"background-color: yellow;"\x3e'+document.getElementById(b).value+"\x3c/span\x3e";PM.toolTipStyle.top=event.clientY+130;PM.toolTipStyle.left=event.clientX+130;PM.toolTipStyle.display="inline"},hideToolTip=function(b){PM.toolTipEle.innerHTML="";PM.toolTipStyle.display="none"},getSpecificXy=function(b,c,d,f){for(var g;b;){d?(c.x+=b.offsetLeft,c.y+=b.offsetTop,g=b.offsetParent):(b.scrollLeft&&(c.x-=b.scrollLeft),b.scrollTop&&(c.y-=b.scrollTop),g=b.parentNode);if(!f&&
"BODY"==b.nodeName.toUpperCase())break;if(!g){g=b.ownerDocument;g||(g=b.getElementsByTagName("body")[0].ownerDocument);b=g.defaultView||g.parentWindow;if(b.parent==b)break;g=b.frameElement;debug("Restarted with parent window element "+g)}b=g}},getPageXy=function(b){var c={y:0,x:0};getSpecificXy(b,c,!0,!0);getSpecificXy(b,c,!1,!0);return c},getDocumentXy=function(b){var c={y:0,x:0};getSpecificXy(b,c,!0,!1);getSpecificXy(b,c,!1,!1);return c},TIMER_ID_PREFIX="timer_",nextTimerIdToUse=0,TimeBomb=function(b,
c,d,f,g){g||(g=window);this.obj=b;this.functionName=c;this.parm=d;this.id=nextTimerIdToUse;nextTimerIdToUse++;this.win=g;g[TIMER_ID_PREFIX+this.id]=this;this.timer=g.setTimeout(TIMER_ID_PREFIX+this.id+".go();",f)};TimeBomb.prototype.go=function(){delete this.win[TIMER_ID_PREFIX+this.id];this.timer=null;try{this.obj[this.functionName](this.parm)}catch(b){debug(this.obj+"with id "+this.obj.id+"."+this.functionName+"("+this.parm+") failed with error "+b)}};
TimeBomb.prototype.stop=function(){this.timer&&(this.win.clearTimeout(this.timer),this.timer=null)};
...
b[f].split(","),c[f]=d;return 0<c.length?c:null},objectToText=function(b){var c=[];objectToTextWorker(b,c,"");return c.join("")},objectToTextWorker=function(b,c,d){if(b&&"object"===typeof b){c.push(" { ");var f=d+"\t",g;for(g in b)c.push("\n"),c.push(f),c.push(g),c.push(" : "),objectToTextWorker(b[g],c,f);c.push("\n");c.push(d);c.push("}")}else c.push(" "),c.push(b),c.push(" ")},overrideAttributes=function(b,c){for(var d in c){var f=c[d];b.hasOwnProperty(d)&&"object"==typeof f?overrideAttributes(b[d],
f):b[d]=f}},queryFieldsToCollection=function(b){debug("going to make a collection out of qry string \x3d "+b);var c={};if(!b)return c;"?"==b.substr(0,1)&&(b=b.substr(1));b=b.split("\x26");var d,f;for(d=0;d<b.length;d++)f=b[d].split("\x3d"),2!=f.length?debug("invalid pair found in query string : "+b[d]):c[f[0]]=decodeURIComponent(f[1].replace(/\+/g," "));return c},evaluateDateShortCuts=function(b){if(!b)return null;b=(new String(b)).toLowerCase();if("."==b||"today"==b)return getToday();if("+"==b||
"tomorrow"==b)return getToday(1);if("-"==b||"yesterday"==b)return getToday(-1);var c=RegExp(/^([-|+])(\d+)$/).exec(b);if(null!=c)return getToday(1*c[0]);if(3!=b.length||"o"!=b.substr(1,1))return null;c=b.substr(0,1);if("b"==c)c=!0;else if("e"==c)c=!1;else return null;var d=b.substr(2,1);b=getToday();switch(d){case "w":d=b.getDate()-b.getDay();c||(d+=6);b.setDate(d);break;case "m":c?b.setDate(1):(b.setMonth(b.getMonth+1),b.setDate(-1));break;case "q":d=b.getMonth();d-=d%3;c?(b.setMonth(d),b.setDate(1)):
(b.setMonth(d+3),b.setDate(-1));break;case "y":c?(b.setMonth(0),b.setDate(1)):(b.setMonth(11),b.setDate(31))}return b},parseDateTime=function(b){var c=b.split(" ");b=parseDate(c[0]);if(!b)return null;if(1>=c.length)return b;var c=c[1].split(":"),d=c[0]?parseInt(c[0],10):0,f=c[1]?parseInt(c[1],10):0,c=c[2]?parseInt(c[2]):0;if(isNaN(d)||23<d||0>d||isNaN(f)||0>f||59<f||isNaN(c)||0>c||59<c)return null;b.setHours(d,f,c);return b},parseDate=function(b){var c=evaluateDateShortCuts(b);c||(c=parseStandardDate(b));
c||(c=parseNonStandardDate(b));return c},parseStandardDate=function(b){var c=b.split(exilParms.dateSeparator);if(3>c.length)return null;b=parseInt(c[exilParms.dateAt],10);if(isNaN(b)||31<b||0>=b)return null;var d=null,d=new String(c[exilParms.monthAt]);exilParms.useMonthName?d=exilParms.monthIndex[d.toLowerCase()]:(d=parseFloat(d,10),d--);if(null==d||isNaN(d)||0>d||11<d)return null;c=parseInt(c[exilParms.yearAt],10);if(isNaN(c)||0>c||9999<c)return null;100>c&&(c=c<exilParms.cutOffForShortYear?2E3+
c:1900+c);b=new Date(c,d,b);return b.getMonth()!=d?null:b},POSSIBLE_SEPARATORS=[" ",".","-","/"],parseNonStandardDate=function(b){for(var c=[],d=POSSIBLE_SEPARATORS.length-1;0<=d;d--){var f=POSSIBLE_SEPARATORS[d];if(0<=b.indexOf(f)){c=b.split(f);break}}if(3<c.length)return null;d=new Date;b=d.getMonth();f=d.getFullYear();d=null;if(1===c.length){if(d=parseInt(c[0],10))if(c=new Date(f,b,d),c.getDate()===d)return c;return null}return 2===c.length?parseDateAndMonth(c[0],c[1],f):parseThreePartDate(c[0],
c[1],c[2])},parseDateAndMonth=function(b,c,d){var f=parseInt(b,10),g=parseInt(c,10),h=exilParms.monthIndex[b.toLowerCase()],k=exilParms.monthIndex[c.toLowerCase()],l=null,m=null;if(3===b.length)if(0<=h&&12>h&&g)l=g,m=h+1;else return null;else if(3===c.length)if(0<=k&&12>k&&f)l=f,m=k+1;else return null;else{if(!f||!g||12<f&&12<g)return null;12<f?(l=f,m=g):12<g?(l=g,m=f):0===exilParms.dateAt?(l=f,m=g):(l=g,m=f)}b=new Date(d,m-1,l);return l===b.getDate()?b:null},parseThreePartDate=function(b,c,d){var f,
g=parseInt(b,10),h=parseInt(c,10);d=parseInt(d,10);if(!d)return null;if(3===c.length){c=exilParms.monthIndex[c.toLowerCase()];if(12>c)c++;else return null;b=g;f=d}else if(3===b.length){c=exilParms.monthIndex[b.toLowerCase()];if(12>c)c++;else return null;b=h;f=d}else{if(!h||!g)return null;1E3<g?(f=g,c=h,b=d):(f=d,12<g?(b=g,c=h):12<h?(b=h,c=g):0===exilParms.dateAt?(b=g,c=h):(b=h,c=g))}g=new Date(f,c-1,b);return g.getDate()!=b?null:g},getToday=function(b){var c=new Date,c=new Date(c.getFullYear(),c.getMonth(),
c.getDate());b&&c.setDate(c.getDate()+b);return c},formatDateTime=function(b){if(!b)return"";var c=formatDate(b),d=b.getHours();10>d&&(d="0"+d);var f=b.getMinutes();10>f&&(f="0"+f);b=b.getSeconds();10>b&&(b="0"+b);return c+" "+d+":"+f+":"+b},formatDate=function(b){if(!b)return"";var c=[],d=b.getDate();10>d&&(d="0"+d);c[exilParms.dateAt]=d;exilParms.useMonthName?d=exilParms.monthNames[b.getMonth()]:(d=b.getMonth()+1,10>d&&(d="0"+d));c[exilParms.monthAt]=d;b=b.getFullYear();c[exilParms.yearAt]=exilParms.useShortYear?
(new String(b)).substr(2,2):b;return c[0]+exilParms.dateSeparator+c[1]+exilParms.dateSeparator+c[2]},getDateTimeParts=function(b,c){var d="",f="00",g="00",h="00",k=0;if(b){var l=b.split(" ");l[0]&&(d=l[0]);l[1]&&(l=l[1].split(":"),l[0]&&(f=l[0],c&&(f=parseInt(l[0],10),12<f&&(f-=12,k=1),10>f&&(f="0"+f))),l[1]&&(g=l[1]),l[2]&&(h=l[2]))}return{dt:d,hr:f,mn:g,sc:h,am:k}},DataCollection=function(b){this.values={};this.lists={};this.grids={};this.success=!0;this.messages={};b&&(this.values[this.AUTHENTICATION_STATUS]=
"0")},a=DataCollection.prototype;a.TABLE_SEPARATOR=String.fromCharCode(28);a.BODY_SEPARATOR=String.fromCharCode(29);a.ROW_SEPARATOR=String.fromCharCode(30);a.FIELD_SEPARATOR=String.fromCharCode(31);a.VALUES_TABLE_NAME="values";a.SUCCESS_FIELD_NAME="_success";a.MESSAGES_TABLE_NAME="_messages";a.MESSAGE_TYPE_ERROR="error";a.MESSAGE_TYPE_WARN="warning";a.AUTHENTICATION_STATUS="authenticationStatus";a.TRACE_FIELD_NAME="exilityServerTraceText";a.PERFORMANCE_FIELD_NAME="exilityServerPerformanceText";
a.fromDc=function(b){this.success=b.success;this.values=b.values;this.messages=b.messages;this.grids=b.grids;this.lists=b.lists};a.addError=function(b){this.addMessage(this.MESSAGE_TYPE_ERROR,b)};a.addMessage=function(b,c){b=b.toLowerCase();var d=this.messages[b];d&&"undefined"!==typeof d||(d=[],this.messages[b]=d);d.push(c);b==this.MESSAGE_TYPE_ERROR&&(this.success=!1)};a.hasValues=function(){for(var b in this.values)return!0;return!1};a.getValue=function(b){return this.values[b]};
a.hasValue=function(b){return"undefined"!==typeof this.values[b]};a.addValue=function(b,c){this.values[b]=c};a.removeValue=function(b){var c=this.values[b];delete this.values[b];return c};a.getGrid=function(b){return this.grids[b]};a.addGrid=function(b,c){this.grids[b]&&debug("grid "+b+" is already in the dc. It will be replaced with the new grid");this.grids[b]=c};a.removeGrid=function(b){var c=this.grids[b];delete this.grids[b];return c};a.addList=function(b,c){this.lists[b]=c};a.getList=function(b){return this.lists[b]};
a.removeList=function(b){var c=this.lists[b];delete this.lists[b];return c};a.hasError=function(){return!this.success};a.getMessageText=function(){var b="",c;for(c in this.messages)for(var b=c==ClientConstants.MESSATE_TYPE_ERROR?b+"Error\n":b+(c+"\n"),d=this.messages[c],f=0;f<d.length;f++)b+=d[f]+"\n";return b};
...
ExilityServerStub.prototype.callService=function(b){var c=b.serviceId;if(!c)throw"Design Error: Service is called with no service ID";var d=b.dc;b.win=this.win;debug("Received a request for service\x3d"+c+" and waitForResponse\x3d"+(b.waitForResponse?"true":"false")+" with following data.");debug(dcToText(d),!0);if(this.win.localServices&&this.win.localServices.hasService(c))debug(c+" is configured as a local service. calling localservices.serve"),b.dc=this.win.localServices.serve(c,b.dc),this.processReturnedDc(b.dc,
b);else{var c=exilParms.serviceName?topPath+exilParms.serviceName:exilParms.commonServiceName,f="";debug("Going to make a request for url "+c);null!=exilityTraceWindow&&d.addValue("exilityServerTrace","1");f=this.serializeDc(d);null!=exilityDataTraceWindow&&datadebug("Request : \x3cbr\x3e"+f);var g=null,g="undefined"!=typeof ActiveXObject?new this.win.ActiveXObject("Microsoft.XMLHTTP"):new this.win.XMLHttpRequest;b.url=c;b.httpObject=g;var h=!b.waitForResponse;if(h){var k=this.SQ.nextIdx;this.SQ.nextIdx++;
this.SQ[k]=b;b.timerHandle=this.win.setTimeout("PM.timeoutCallback(serverStub, "+k+")",this.TIMEOUT);g.onreadystatechange=this.win.getCallbackFunction(k);this.win.serverStub||(this.win.serverStub=this)}try{g.open("POST",c,h);g.setRequestHeader("Content-Type","text/html; charset\x3dutf-8");var l=PM.getCsrfToken();l&&g.setRequestHeader(ClientConstants.CSRF_HEADER,l);g.send(f)}catch(m){"paginationService"==b.serviceId&&"0"==d.values.pageNo?debug("Ignoring the network error, as it is supposed to remove session data only"):
message("Application is unable to process your request because network connection is not available. Please establish Network connection and try again.","","Ok",null,null,null);b.disableForm&&uncoverPage(coverPickerStyle,imgMainPrgIndStyle);return}b.waitForResponse&&this.processServiceEntry(b)}};ExilityServerStub.prototype.httpCallBack=function(b){var c=this.SQ[b];!c||4>c.httpObject.readyState||(delete this.SQ[b],c.timerHandle&&this.win.clearTimeout(c.timerHandle),this.processServiceEntry(c))};
...
"invalidDataFromServer")||"Unable to get response from server.\n"+h;alert(f);this.windup();return}if(f=b.httpObject.getResponseHeader(ClientConstants.CSRF_HEADER))f===ClientConstants.REMOVE_CSRF&&(f=null),this.setCsrfToken(f);this.handleReturnedDc(d,b)}}};ExilityServerStub.prototype.windup=function(b,c){c&&b.field&&b.field.descServiceId&&(b.field.isValid=!1);b.disableForm&&uncoverPage(coverPickerStyle,imgMainPrgIndStyle);b.showPage&&b.win.P2&&b.win.P2.showPage()};
ExilityServerStub.prototype.handleReturnedDc=function(b,c){this.processReturnedDc(b,c)};ExilityServerStub.prototype.processServiceQ=function(){if(this.refreshPageUnderProgress)debug(" another srvice is Still busy, Once again going to set a timeout"),this.win.setTimeout("P2.processServiceQ();",100);else{var b=this.pendingServices.pop();b?(this.refreshPageUnderProgress=!0,this.processReturnedDc(b.dc,b.se),this.refreshPageUnderProgress=!1):debug("design error: pendingServices is empty when I tried to wake up and process it")}};
...
debug(dcToText(b),!0);d=b.values[ClientConstants.AUTH_STATUS];if(0<d){if(1==d){if(pendingServerCalls){pendingServerCalls.push(c);debug(c.serviceId+" added to the pending sessioned out q.");return}debug("pendingServiceCalls initiated, and added "+c.serviceId+" to it.");pendingServerCalls=[c]}d=window.relogin;if(!d)try{d=parent.relogin||top.relogin}catch(f){}d&&"function"==typeof d?(PM.debug(" Going to invoke relogin function "),d(b,c)):alert("Authentication failed. Please login to the system again.");
return}}if(d=getMessageText(b))if(PM.message(d,"","Ok",null,null,null),d=document.getElementById("warningMsg"))d.style.display="";c.dc=b;this.win.dc=b;if(b.success){var g=b.grids[ClientConstants.GLOBAL_FIELDS];if(g){d=g.length;if(2==d&&2<g[0].length){d=g[0].length;for(var h=g[0],g=g[1],k=0;k<d;k++){var l=h[k];"localDateFormat"==l?setLocalDateFormat(g[k]):globalFieldValues[l]=g[k]}}else for(k=1;k<d;k++)h=g[k],l=h[0],"localDateFormat"==l?setLocalDateFormat(h[1]):globalFieldValues[l]=h[1];debug(d-1+
" global fields set")}PM.backgroundJobs||(PM.backgroundJobs=new BackgroundJobs);PM.backgroundJobs.setAllBackgroundJobStatuses(c);(d=c&&c.win&&c.win.P2)?(c.toRefreshPage==ServerAction.BEFORE&&d.refreshPage(b,c.listServiceOnLoad),this.doCallBack(c),c.toRefreshPage==ServerAction.AFTER&&d.refreshPage(b,c.listServiceOnLoad)):this.doCallBack(c);this.windup(c,!1);if(c.fieldToFocusAfterExecution&&(d=c.win.P2.doc.getElementById(c.fieldToFocusAfterExecution)))try{d.focus()}catch(m){}}else debug("server error status is ERROR: No data refresh is going to happen"),
c.callBackEvenOnError&&this.doCallBack(c),this.windup(c,!0)};ExilityServerStub.prototype.doCallBack=function(b){if(b.simpleCallBack)return b.simpleCallBack(b.dc);var c=b.callBackAction;if(c){if("function"==typeof c)return c(b.callBackObject,b.fieldName,b,b.listServiceOnLoad);var d=b.win[c]&&b.win[c].serviceReturned;return d?d(b.dc):b.win.P2.act(b.callBackObject,b.fieldName,c,b,b.listServiceOnLoad)}if(b.callBackObject&&b.callBackObject.serviceReturned)return b.callBackObject.serviceReturned(b.dc)};
...
ExilityServerStub.prototype.getResponse=function(b,c,d){b=new ServiceEntry(b,c,!0,null,null,null,ServerAction.NONE,!1,!1);if(!d)return this.callService(b),b.dc;b.waitForResponse=!0;b.callBackEvenOnError=!0;b.toRefreshPage=ServerAction.NONE;b.simpleCallBack=d;this.callService(b)};ExilityServerStub.prototype.resendServices=function(){if(pendingServerCalls&&pendingServerCalls.length)for(var b=0;b<pendingServerCalls.length;b++)this.callService(pendingServerCalls[b]);pendingServerCalls=null};
ExilityServerStub.prototype.getCsrfToken=function(){return window[ClientConstants.CSRF_HEADER]};var getCsrfToken=function(){return window[ClientConstants.CSRF_HEADER]},setCsrfToken=function(b){window[ClientConstants.CSRF_HEADER]=b};ExilityServerStub.prototype.setCsrfToken=function(b){window[ClientConstants.CSRF_HEADER]=b;var c=PM.exilityIdeWindow;c&&!c.closed&&c.setCsrfToken(b)};var AbstractField=function(){this.value="";this.columnIdx=-1;this.defaultValue="";this.isEditable=!0};
AbstractField.inrPrefixes="   ,  ,  ,  ,  ,  ,  ,  ,   ".split(" ");AbstractField.usdPrefixes="   ,   ,   ,   ,   ,   ,    , ".split(" ");a=AbstractField.prototype;a.format=function(b){if(!this.formatter||"none"==this.formatter)return b;var c=window.fieldFormatters&&window.fieldFormatters[this.formatter];if(c)return c(b);debug("Design error: either formatter.js is not included in index page. or "+this.formatter+" is not a valid formatter.");return b};
a.deformat=function(b){return(formatter=this.formatter)&&"none"!=formatter?-1!=formatter.indexOf("eur")?b.replace(/\./g,""):b.replace(/,/g,""):b};
...
a.initialize=function(){this.value=this.isChecked?this.checkedValue:this.uncheckedValue};a.getValueFromObject=function(b){return b.checked?this.checkedValue:this.uncheckedValue};a.hasValue=function(){return this.isChecked};a.setValueToObject=function(b,c){var d=c.toUpperCase();b.checked=c==b.value||c==this.checkedValue||"1"==c||"Y"==d||"YES"==d||"TRUE"==d?this.isChecked=!0:this.isChecked=!1};
var HiddenField=function(){AbstractInputField.call(this);this.isHidden=!0;this.isEditable=!1},a=HiddenField.prototype=new AbstractInputField;a.setValueToObject=function(b,c){b&&(b.value=c)};a.getValueFromObject=function(b){if(b)return b.value;debug("Hidden field shoudl not be used as a dom element. use P2.getFieldValue(fieldName) instead.");return null};var RadioButtonField=function(){AbstractInputField.call(this);this.isRadio=!0},a=RadioButtonField.prototype=new AbstractInputField;
...
d.push(h),d.push("\x3c/th\x3e");d.push("\x3c/tr\x3e\x3c/thead\x3e\x3ctbody\x3e");for(g=0;g<f;g++){d.push("\x3ctr\x3e");var k=c[g];b.helpTexts&&(d.push("\x3ctd\x3e"),d.push(b.helpTexts[g]),d.push("\x3c/td\x3e"));for(h=0;h<k.length;h++)d.push("\x3ctd\x3e"),d.push(k[h]),d.push("\x3c/td\x3e");d.push("\x3c/tr\x3e")}d.push("\x3c/tbody\x3e\x3c/table\x3e\x3cbr /\x3e\x3cbr /\x3e")}else d.push("\x3cbr /\x3e\x3cdiv\x3e NO DATA \x3c/div\x3e\x3cbr /\x3e")}},JtablePanel=function(){AbstractTable.call(this)},a=JtablePanel.prototype=
new AbstractTable;a.LOAD="load";a.ADD_RECORD="addRecord";
a.init=function(){if(!this.inited){this.nbrRows=0;var b=this.P2.win,c={};PM.jtableDefaultOptions?(debug("Going to use default options :\n "+objectToText(PM.jtableDefaultOptions)),PM.overrideAttributes(c,PM.jtableDefaultOptions),debug("Resultant object is :\n"+objectToText(c))):debug("PM.jtableDefaultOptions \x3d "+PM.jtableDefaultOptions);this.label&&(c.title=this.label);this.pageSize&&0<this.pageSize&&(c.paging=!0,c.pageSize=this.pageSize,b[this.name+"PageSize"]=this.pageSize,this.P2.addPageSize(this.name,
this.pageSize));c.actions=this.getActionOption();c.fields=this.getFieldOption();var d=b[this.name+"JtableOptions"];d?(debug("page has set pageOptions to \n"+objectToText(d)),PM.overrideAttributes(c,d)):debug("pageOptions \x3d "+d);debug("jtable optins for "+this.name+"\n"+PM.objectToText(c));this.jtableEle=b.$("#"+this.name);this.jtableEle.jtable(c);this.inited=!0}};
a.getFieldOption=function(){var b={},c;for(c in this.columns){var d=this.columns[c],f={};d.defaultValue&&(f.defaultValue=d.defaultValue);d.label&&(f.title=d.label);d.width&&(f.width=d.width);d.isHidden&&(f.type="hidden");b[c]=f}if(c=this.idFieldName&&this.P2.getField(this.idFieldName))if(c=b[c.unqualifiedName])c.key=!0;this.idFieldName&&b[this.idFieldName]&&(b[this.idFieldName].key=!0);return b};
a.getActionOption=function(){var b=this,c={listAction:function(c,f){return b.listAction(c,f)}};this.rowsCanBeAdded&&(c.createAction=function(c,f){return b.jtableAction(PM.ClientConstants.TABLE_ACTION_ADD,c,f)});this.rowsCanBeModified&&(c.updateAction=function(c,f){return b.jtableAction(PM.ClientConstants.TABLE_ACTION_MODIFY,c,f)});this.rowsCanBeDeleted&&(c.deleteAction=function(c,f){return b.jtableAction(PM.ClientConstants.TABLE_ACTION_DELETE,c,f)});return c};
a.listAction=function(b,c){if(this.setDataInProgress)return this.setDataInProgress=!1,this.getResponseObject();if(!this.totalRows)return this.sort(c.jtSorting),this.getResponseObject();this.pageSize!=c.jtPageSize&&(this.pageSize=c.jtPageSize,this.P2.addPageSize(this.name,this.pageSize));var d=c.jtStartIndex/this.pageSize+1,f=c.jtSorting,g=0;if(f){var h=f.split(" "),f=h[0];"ASC"!=h[1]&&(g=1)}h=new DataCollection;h.values.tableName=this.name;h.values.pageNo=d;h.values.pageSize=this.pageSize;f&&(h.values.paginationColumnToSort=
f,h.values.paginationSortDesc=g);var k=this,d=this.P2.win,l=d.$.Deferred();d.serverStub.getResponse("paginationService",h,function(b){l.resolve(k.paginationDcToResponse(b))});return l};
a.jtableAction=function(b,c,d){debug("postData  : "+objectToText(c)+"parms : "+d);d=this.P2.actions[this.rowSaveActionName];if(!d)return this.getErrorResponse("intenral rowSaveActionName not set for this jtable.");var f=this.P2.win,g=f.$.Deferred(),h=this;b=this.postDataToDc(b,c);f.serverStub.getResponse(d.serviceId,b,function(b){g.resolve(h.dcToResponseObject(b))});return g};
a.postDataToDc=function(b,c){var d=new PM.DataCollection;d.addValue(PM.ClientConstants.TABLE_ACTION_FIELD_NAME,b);var f=null;"object"==typeof c?(debug("Going to use postData as fields"),f=c):f=PM.queryFieldsToCollection(c);for(var g in f)d.addValue(g,f[g]);return d};a.dcToResponseObject=function(b){if(!b.success)return this.getErrorResponse(b.getMessageText());var c={},d;for(d in this.columns)c[d]=b.getValue(d);return{Result:"OK",Record:c}};
a.getResponseObject=function(){var b=[];if(this.serverData&&1<this.serverData.length)for(var c=this.serverData,d=c.length,f=c[0],g=f.length,h=1;h<d;h++){for(var k=c[h],l={},m=0;m<g;m++)l[f[m]]=k[m];b.push(l)}return{Result:"OK",Records:b,TotalRecordCount:this.totalRows||this.nbrRows}};
a.setData=function(b,c){var d=b.grids[this.name],f=d.length;c?1<f&&this.appendRows(d):(d=b.grids[this.name],f=d.length,this.serverData=d,this.nbrRows=f-1,this.totalRows=b.values[this.name+"TotalRows"]||0,this.setDataInProgress=!0,this.jtableEle.jtable(this.LOAD))};a.deleteAllRows=function(){this.serverData&&(this.serverData.length=1,this.totalRpws=this.nbrRows=0);this.jtableEle.jtable(this.LOAD)};
a.appendRows=function(b){var c=b.length;if(!(2>c))for(var d=b[0],f=d.length,g={clientOnly:!0},h=1;h<c;h++){for(var k={},l=b[h],m=0;m<f;m++)k[d[m]]=l[m];g.record=k;this.jtableEle.jtable(this.ADD_RECORD,g)}};a.setColumnValue=function(b,c,d){throw"setColumn() is not yet implementedfor jTable";};a.setCurrentRow=function(b){this.currentRow=b};
a.paginationDcToResponse=function(b){if(!b.success)return this.getErrorResponse(b.getMessageText());b=b.grids[this.name];this.serverData.length=1;this.nbrRows=b.length;for(var c=0;c<this.nbrRows;c++)this.serverData.push(b[c]);return this.getResponseObject()};a.getErrorResponse=function(b){return{Result:"ERROR",Message:b}};
a.sort=function(b){if(this.nbrRows){var c=b.split(" ");b=c[0];for(var c=1<c.length&&"DESC"==c[1],d=this.serverData[0],f=d.length,g=!1,h=/^[\d\.]*$/,k=-1,l=0;l<f;l++)d[l]==b&&(k=l,g=h.test(this.serverData[1][l]));if(-1==k)PM.debug(b+" is not a column. sorting is abandoned.");else{b=this.getSortedIndexes(k,g);c&&b.reverse();c=[ths.serverData[0]];for(d=0;d<this.nbrRows;d++)newdata.push(this.serverData[b[d].i]);this.serverData=c}}};
a.getSortedIndexes=function(b,c){for(var d=[],f=1;f<=this.nbrRows;f++){var g=this.serverData[f][b];if(c){g=parseFloat(g);if(NaN==g)return this.getSortedIndexes(b,!1);d.push({i:f,v:g})}}d.sort(this.sortFunction);return d};a.sortFunction=function(b,c){var d=b.v,f=c.v;return d?f?d==f?0:d>f?1:-1:1:f?-1:0};
var ExilityPage=function(b,c){this.win=b;this.doc=b.document;this.name=c;this.pageParameters={};this.fields={};this.fieldNames=[];this.tables={};this.actions={};this.idSplitter="___"},PageParameter=function(){},a=ExilityPage.prototype;a.addParameter=function(b){b.P2=this;this.pageParameters[b.name]=b};a.getParameter=function(b){return this.pageParameters[b]};
...
a.getFieldObject=function(b,c){var d=this.fields[b];if(!d)return null;d=d.table?d.table.getObjectId(b,c):b;return this.doc.getElementById(d)};a.addAction=function(b){b.P2=this;this.actions[b.name]=b};a.getAction=function(b){return this.actions[b]};a.addTable=function(b){b.P2=this;this.tables[b.name]=b;b.pageSize&&!b.localPagination&&this.addPageSize(b.name,b.pageSize);if(b.linkedTableName||b.mergeWithTableName||b.nestedTableName)this.hasLinkedTables=!0};a.getTable=function(b){return this.tables[b]};
...
this.doc.body.clientWidth+"px",this.myCoverStyle.display="block"),c.style.position="relative",c.style.zIndex=10,this.poppedUpPanel=c):debug("Error: "+b+" is not found as a DOM element. popup option failed ")};a.popDown=function(){this.poppedUpPanel?(this.myCoverStyle&&(this.myCoverStyle.display="none"),this.poppedUpPanel.style.position="",this.poppedUpPanel=null):debug("Nothing to popdown")};a.addPageSizes=function(b){if(this.pageSizes)for(var c in this.pageSizes)b.values[c+"PageSize"]=this.pageSizes[c]};
a.addPageSize=function(b,c){this.pageSizes||(this.pageSizes={});this.pageSizes[b]=c};
...
var coverPage=function(b,c,d){var f=document.getElementById("loading");f&&(f.style.display="");c&&(c.width=mainBody.scrollWidth+"px",c.height=mainBody.scrollHeight+"px");b&&(b.display="");d&&(d.display="")},uncoverPage=function(b,c,d){d&&(d.display="none");if(d=document.getElementById("loading"))d.style.display="none";b&&(b.display="none");c&&(c.display="none")},ObjectToValidate=function(b,c){this.obj=c;this.field=b;this.timer=null};
a.getComboUrl=function(b,c,d){c=this.fields[d];b=exilParms.comboServiceName+"?serviceId\x3d"+c.descServiceId;c=this.makeQueryString(c.descQueryFields,c.descQueryFieldSources,null,c.validateQueryFields,c.name);if(!1==c)return null;c&&(b+="\x26"+c);return b};a.inputFocusOut=function(b,c){debug(c+" lost focus");exilComboWin&&exilComboWin.inputFocusOut();var d=this.fields[c];d.blurred&&!1==d.blurred(b)||(d.isChanged(b)&&this.fieldChanged(b,c),d.onBlurActionName&&this.act(b,c,d.onBlurActionName,null))};
